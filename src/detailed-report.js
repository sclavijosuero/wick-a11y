 ...
 */
const buildDetailedHtmlReportBody = (reportInfo, options) => {
    ...
    <head>
        ...
        <title>Wick-A11y Detailed Accessibility Report</title>
        <style>
    ...
    <body>
        ...
        <div class="container">
            <header role="banner">
                <h1 class="header" tabindex="-1">Wick-A11y Detailed Accessibility Report</h1>
        ...
        <script>
            ...
            function initializeScreenshotOverlays() {
                ...
                window.addEventListener('resize', () => {
                    // Close all open tooltips when resizing
                    const allOverlays = overlayContainer.querySelectorAll('.screenshot-overlay');
...
export default buildDetailedHtmlReportBody
